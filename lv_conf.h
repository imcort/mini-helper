...
#define LV_HOR_RES_MAX          (144)
#define LV_VER_RES_MAX          (168)
...
#else       /*LV_MEM_CUSTOM*/
#  define LV_MEM_CUSTOM_INCLUDE "mem_manager.h"   /*Header for the dynamic memory function*/
#  define LV_MEM_CUSTOM_ALLOC   nrf_malloc       /*Wrapper to malloc*/
#  define LV_MEM_CUSTOM_FREE    nrf_free         /*Wrapper to free*/
#endif     /*LV_MEM_CUSTOM*/
...
#if LV_ENABLE_GC != 0
#  define LV_GC_INCLUDE "mem_manager.h"                           /*Include Garbage Collector related things*/
#  define LV_MEM_CUSTOM_REALLOC   nrf_realloc           /*Wrapper to realloc*/
#  define LV_MEM_CUSTOM_GET_SIZE  lv_mem_get_size      /*Wrapper to lv_mem_get_size*/
#endif /* LV_ENABLE_GC */
 ...
 */
#define LV_FONT_CUSTOM_DECLARE 	LV_FONT_DECLARE(Monsterrat) 
...
#define LV_THEME_DEFAULT_FONT_SMALL         &Monsterrat
#define LV_THEME_DEFAULT_FONT_NORMAL        &Monsterrat
#define LV_THEME_DEFAULT_FONT_SUBTITLE      &Monsterrat
#define LV_THEME_DEFAULT_FONT_TITLE         &Monsterrat
